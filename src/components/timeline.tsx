...
const DEFAULT_STEPS = [
  ...
  { id: 4, date: "25/08/2025", label: "PAGAMENTO", title: "Pagamento integral", body: "Pagamento à vista via boleto no valor de R$ 12.480,21 (beneficiário final: Razor Technologies do Brasil LTDA).", source: "ANEXO 05 [9] / Dossiê [3]", accent: "#0C3E52" },
  ...
  { id: 8, date: "21/10/2025", label: "ATRASO 2", title: "2º atraso / alegação: imprevistos", body: "Novo comunicado: “imprevistos fora de controle”; remarca envio para 28/11/2025.", source: "Dossiê [3] / ANEXO 13 [2]", accent: "#FF6B6B" },
  ...
  { id: 14, date: "06/02/2026", label: "B.O. (MS)", title: "Registro de ocorrência nº 16/2026", body: "Boletim de Ocorrência na Polícia Civil do MS por Estelionato (Art. 171 do CP).", source: "ANEXO 11 [4]", accent: "#34D399" },
  { id: 15, date: "09/02/2026", label: "B.O. (RS)", title: "Registro de ocorrência (RS) online", body: "Boletim de Ocorrência na Delegacia Online do RS, também por Estelionato.", source: "ANEXO 12 [5]", accent: "#A78BFA" },
];
